...
public class Index_Auto_2fParticipants_2fByIsAdminAndUsername : Raven.Database.Linq.AbstractViewGenerator
{
	public Index_Auto_2fParticipants_2fByIsAdminAndUsername()
	{
		this.ViewText = @"from doc in docs.Participants
select new { Username = doc.Username, IsAdmin = doc.IsAdmin }";
