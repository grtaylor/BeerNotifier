...
public class Index_Auto_2fParticipants_2fByForceAndLastPurchaseAndUsernameSortByLastPurchase : Raven.Database.Linq.AbstractViewGenerator
{
	public Index_Auto_2fParticipants_2fByForceAndLastPurchaseAndUsernameSortByLastPurchase()
	{
		this.ViewText = @"from doc in docs.Participants
select new { Username = doc.Username, LastPurchase = doc.LastPurchase, Force = doc.Force }";
