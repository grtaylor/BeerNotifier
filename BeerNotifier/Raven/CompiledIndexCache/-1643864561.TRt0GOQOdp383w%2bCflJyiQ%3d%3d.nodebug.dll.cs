...
public class Index_Auto_2fParticipants_2fByForceAndIsAdminAndLocationAndUsername : Raven.Database.Linq.AbstractViewGenerator
{
	public Index_Auto_2fParticipants_2fByForceAndIsAdminAndLocationAndUsername()
	{
		this.ViewText = @"from doc in docs.Participants
select new { Location = doc.Location, Force = doc.Force, Username = doc.Username, IsAdmin = doc.IsAdmin }";
